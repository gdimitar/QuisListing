...
public enum PasswordStrengthUtil {
    ...
    PasswordStrengthUtil(final int resId, final int color) {
        this.resId = resId;
        this.color = color;
    }
    ...
    public static PasswordStrengthUtil calculateStrength(final String password) {
        int currentScore = 0;
