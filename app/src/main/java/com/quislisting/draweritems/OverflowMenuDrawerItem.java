package com.quislisting.draweritems;
...
public class OverflowMenuDrawerItem extends BaseDescribeableDrawerItem<OverflowMenuDrawerItem,
        OverflowMenuDrawerItem.ViewHolder> {
    private int mMenu;

    public OverflowMenuDrawerItem withMenu(final int menu) {
        this.mMenu = menu;
        return this;
    }
    ...
    public OverflowMenuDrawerItem withOnMenuItemClickListener(
    ...
    public OverflowMenuDrawerItem withOnDismissListener(
            final PopupMenu.OnDismissListener onDismissListener) {
    ...
    @Override
    public void bindView(final ViewHolder viewHolder, final List payloads) {
        ...
        //handle image
        viewHolder.menu.setImageDrawable(new IconicsDrawable(ctx,
                GoogleMaterial.Icon.gmd_more_vert).sizeDp(12).color(getIconColor(ctx)));
